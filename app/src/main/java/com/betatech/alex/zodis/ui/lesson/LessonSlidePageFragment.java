...
public class LessonSlidePageFragment extends Fragment {
    ...
    @BindView(R.id.text_root_word)
    TextView rootWordTextView;
    @BindView(R.id.text_description_word)
    TextView rootWordDescriptionTextView;
    @BindView(R.id.recycler_derived_words)
    RecyclerView derivedList;
