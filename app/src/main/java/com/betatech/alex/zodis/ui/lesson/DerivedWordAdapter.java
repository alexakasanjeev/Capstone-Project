...
public class DerivedWordAdapter extends RecyclerView.Adapter<DerivedWordAdapter.DerivedWordViewHolder> {
    ...
    DerivedWordAdapter(Context mContext, ArrayList<DerivedWord> derivedWords) {
  ...
  /*  public void swapList(ArrayList<DerivedWord> words) {
    ...
    class DerivedWordViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.text_derived_word_name)
        TextView nameTextView;
        @BindView(R.id.text_deried_word_description)
        TextView descriptonTextView;

        DerivedWordViewHolder(View itemView) {
            super(itemView);
